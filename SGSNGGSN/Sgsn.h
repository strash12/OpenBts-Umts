...
class GmmInfo
{
	...
	// the time we learn the IMSI (and create the GmmInfo) and when we perform the changeTLLI procedure.
...
#if RN_UMTS
	// When we send a security mode command we save the state here so we know what to do
